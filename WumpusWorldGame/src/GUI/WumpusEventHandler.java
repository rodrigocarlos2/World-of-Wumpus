...
public class WumpusEventHandler extends JFrame implements ActionListener,MouseListener , MouseMotionListener , KeyListener{
	...
	private static ArrayList<NumberXY> numbersXY = new ArrayList<NumberXY>();
    ...
    private void loadData(String str){
        ...
        int agentRow = 4;
        int agentCol = 1;
        // Position defined of Agent in Game
        ...
        if(wumpusRow==4 && wumpusCol==1){
        	wumpusCol=3;
        }
        
        if(wumpusCol<4){
        	array[wumpusRow][wumpusCol+1].images.add(Elements.newStench());
        }
        if(wumpusCol>1){
        	array[wumpusRow][wumpusCol-1].images.add(Elements.newStench());
        }
        if(wumpusRow>1){
        	array[wumpusRow-1][wumpusCol].images.add(Elements.newStench());
        }
        if(wumpusRow<4){
        	array[wumpusRow+1][wumpusCol].images.add(Elements.newStench());
        }
        ...
        while(wumpusRow==agentRow && wumpusCol==agentCol){
    ...
    private void createNewWorld()
    {
        ...
        answer = (JOptionPane.showInputDialog(this,  "Choose world`s dimension", "Dimension of"
    ...
    private void step(){
        ...
        if(this.wumpusWorld.agentDied()){
            ...
            wumpusWorld.setScoreAgent(-1000);
            
            System.out.println("Score: "+wumpusWorld.getScoreAgent());
        ...
        String f = this.wumpusWorld.moveAgent();
        
        if(f.equals("F")){
        	wumpusWorld.setScoreAgent(-1);
        }
        ...
        // here the direction and atual positions are defined
        ...
        // If hasGold is equals to 'true', so, gold was found.
        
        if(hasGold==true){
        	System.out.println("It is gold!!!");
        }
    ...
    private void startSimulation(){
        ...
        if(!running){
            ...
            answer = (JOptionPane.showInputDialog(this, "Choose agents`s maximum steps :", "Max Steps of", JOptionPane.PLAIN_MESSAGE, null
