...
public class WumpusWorld {
    ...
    public int getScoreAgent(){
    	return this.agent.score;
    }
    
    public void setScoreAgent(int score){
    	this.agent.score += score;
    }
    ...
    public int[] getAgentCurrentStatus(){
        ...
        return new int[] { 
        		this.agent.getArea().getRow(),this.agent.getArea().getCol(), this.agent.getDirection()	
        };
    ...
    public void print (PrintStream printStream)
    {
        ...
        for(int i = 0 ; i < this.dimension; i++){
            ...
            for(int j = 0; j < this.dimension;j++){
                ...
                if(this.world[i][j].hasWumpus())temp += "W";
                if(this.world[i][j].stenches())temp += "F";
                if(this.world[i][j].hasWall())temp += "-";
                if(this.world[i][j].glitters())temp += "G";
                if(this.world[i][j].hasPit())temp += "O";
                ...
                if(this.world[i][j].equals(agent.getArea())){
                    ...
                    if(this.agent.getDirection() == 1)
                    	direction = "U";
                    if(this.agent.getDirection() == 2)
                    	direction = "R";
                    if(this.agent.getDirection() == 3)
                    	direction = "D";
                    if(this.agent.getDirection() == 4)
                    	direction = "L";
