...
public class Agent
{
    ...
    private void updateKB(){
        ...
        for(int row = 0; row < dimension; row++){
            for(int col = 0; col < dimension; col++){
                //time dependant
                //Î§Ï�Î¿Î½Î¹ÎºÎ¬ Î²Î®Î¼Î±Ï„Î±. ÎŸ Ï€Ï�Î¬ÎºÏ„Î¿Ï�Î±Ï‚ Ï€Ï�Î­Ï€ÎµÎ¹ Î½Î± ÏƒÏ…Î¼Ï€ÎµÏ�Î±Î¯Î½ÎµÎ¹ Î¼ÏŒÎ½Î¿Ï‚ Ï„Î¿Ï… Ï„Î± Ï‡Ï�Î¿Î½Î¹ÎºÎ¬ ÎµÎ¾Î±Ï�Ï„ÏŽÎ¼ÎµÎ½Î± Ï€ÎµÎ´Î¯Î± Ï„Î¿Ï… ÏŒÏ€Ï‰Ï‚ Ï€Ï‡ Î· Î¸Î­ÏƒÎ· Ï„Î¿Ï…
                //ÎºÎ±Î¹ Î½Î± Î¼Î· Î²Ï�Î¯ÏƒÎºÎµÏ„Î±Î¹ ÏƒÎµ ÏƒÏ�Î³Ï‡Î·ÏƒÎ· Î³Î¹Î± Ï„Î¿ Ï€ÏŒÏ„Îµ ÎµÎ¯Î´Îµ Ï„Î¹, Ï€Î¿Ï� Î²Ï�Î¹ÏƒÎºÏŒÏ„Î±Î½ ÏƒÎµ Ï€Î¿Î¹Î± Ï‡Ï�Î¿Î½Î¹ÎºÎ® ÏƒÏ„Î¹Î³Î¼Î® ÎºÏ„Î»...
                for(int t = time; t <= time; t++){                    
                    //At(t,x,y) ^ breeze(t) => breezySquare(x,y)                                            
                    sen = new HornSentence(new Literal (breezy + (row) + "" + (col) , false)
                            //Î”ÎµÎ½ ÎµÏ‡ÎµÎ¹ Ï‡Ï�Î¿Î½Î¹ÎºÎ¿ Î¿Ï�Î¹ÏƒÎ¼Î± Î³Î¹Î±Ï„Î¯ Î¿Î¹ Î±Ï�Ï�ÎµÏ‚ Î´ÎµÎ½ Î±Î»Î»Î¬Î¶Î¿Ï…Î½ ÎºÎ±Ï„Î¬ÏƒÏ„Î±ÏƒÎ· Î¼Îµ Ï„Î¿ Ï‡Ï�ÏŒÎ½Î¿
    ...
    public String toString(){
        ...
        String eol = "\r\n";
        String str = "Hi I am  " + this.name + " ... " + eol + "Informations ..."  + eol;
        
        if(this.hearsScream){
            str+= "GOLLUM DIED by the sword STING...." + eol;
            return str;
        }
